...
function post($title,$content,$category_id,$posted){
    ...
    $sql = "INSERT INTO image(title,content,writter,category_id,date,posted) VALUES(:title,:content,:writter,:category_id,NOW(),:posted)";
    $req = $db->prepare($sql);
    $req->execute($p);
}
