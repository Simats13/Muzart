...
if($post == false){
    ...
    ?>
        <section class="dark-wrapper opaqued parallax" data-parallax="scroll" src="img/posts/<?= $post->image ?>" alt="<?= $post->title?>" data-speed="0.7">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 mt30 wow">
                            ...
                            <div class="item-metas text-muted mb30 white">
                                <span class="meta-item"><i class="pe-icon pe-7s-folder"></i> Posté dans<span> <?= $post->category?></span></span>
                                <span class="meta-item"><i class="pe-icon pe-7s-ticket"></i> Tags <span><?= $post->tags?></span></span>
