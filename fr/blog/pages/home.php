                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <!--AFFICHE L'IMAGE DU POST SELON l'ID -->
                                            ...
                                            <div class="hover-item-caption smoothie">
                                                <h3 class="vertical-center smoothie"><a
                                                        ...
                                                        title="view article"><?php $langue=0;
                                                                        if(isset($_GET["lang"]))
                                                                        $langue=1;
                                                                        $description = array("Voir l'article","
                                                                        See the article");
                                                                    echo $description[$langue]; ?> </a></h3>
                                        ...
                                        <div class="item-metas text-muted mb30">
                                            <span class="meta-item"><i class="pe-icon pe-7s-folder"></i><?= $langue=0;
                                                                        if(isset($_GET["lang"]))
                                                                        $langue=1;
                                                                        $description = array("POSTE LE","
                                                                        POSTED IN");
                                                                    echo $description[$langue]; ?>
                                            <!--AFFICHE LA DATE DE L'ARTICLE SELON l'ID -->
                                                <span><?= date("d/m/Y à H:i",strtotime($post->date)); ?></span></span>
                                            <span class="meta-item"><i class="pe-icon pe-7s-user"></i><?= $langue=0;
                                                                        if(isset($_GET["lang"]))
                                                                        $langue=1;
                                                                        $description = array("Autheur","
                                                                            Author");
                                                                    echo $description[$langue]; ?>
                                        ...
                                        <a class="btn btn-primary mt30"
                                            href="index.php?page=post&id=<?= $post->id ?>"><?php $langue=0;
                                                                        if(isset($_GET["lang"]))
                                                                        $langue=1;
                                                                        $description = array("Lire l'article au complet","
