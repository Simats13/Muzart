                    ...
                    <div class="row">
                        <div class="col-md-12 text-center mb50">
                            ...
                            echo $description[$langue]; ?></a></li>
                                <li><a class="btn btn-primary" href="#" data-filter=".apps"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Apps","Apps");
                            echo $description[$langue]; ?></a></li>
                                <li><a class="btn btn-primary" href="#" data-filter=".design"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Conception","Design");
                            echo $description[$langue]; ?></a></li>
                                <li><a class="btn btn-primary" href="#" data-filter=".photography"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Photographie","Photography");
                            echo $description[$langue]; ?></a></li>
                                <li><a class="btn btn-primary" href="#" data-filter=".video"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Vidéo","Video");
                            echo $description[$langue]; ?></a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <ul class="portfolio-items nopadding-lr isotope list-unstyled">
                            <li class="col-sm-4 col-xs-12 portfolio-item nopadding-lr apps isotope-item">
                                <div class="hover-item">
                                    <img src="assets/img/portfolio/porfolio1.jpg" class="img-responsive smoothie" alt="">
