...
if(isset($_GET['delete'])) {
    $req=$db->query('DELETE FROM posts WHERE id= '.$_GET['delete']);
...
?>
    ...
    <div class="col s6">
        ...
        <a href="?page=post&id=<?= $post->id ?>&delete=<?=$post->id?>&delete_images=<?= $post->id?>" class="btn btn-danger" id="delete" name="delete" onclick="return confirm('Voulez-vous supprimer l\'article ?') onclick="document.location.href= '?'">Supprimer</a>
