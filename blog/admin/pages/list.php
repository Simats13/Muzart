...
foreach($posts as $post){
        ...
        <div class="col s12">
            ...
            <div class="row">
                ...
                <div class="col s12 m6 l4">
                    ...
                    <td><a href="?page=post&id=<?=$post->id ?>&delete=<?=$post->id ?>" id="<?=$post->id ?>" name="<?=$post->id?>" class="btn-floating btn-small waves-effect waves-light red delete_comment"><i class="material-icons">delete</i></a></td>
                </div>
            </div>
        </div>
    </div>
    ...
    ?>
        <tr>
            ...
            <td><h4><center><a href="?page=write"> Ajouter un article </a></center></h4></td>
        </tr>
    <?php
}
