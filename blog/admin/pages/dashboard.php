                ...
                ?>
                    <tr id="commentaire_<?= $comment->id ?>">
                        ...
                        <td>
                            ...
                            <a href="?page=deleted&id=<?= $comment->id ?>" id="<?= $comment->id ?>" class="btn-floating btn-small waves-effect waves-light red delete_comment"><i class="material-icons">delete</i></a>
                            ...
                            <div class="modal" id="comment_<?= $comment->id?>">
                                ...
                                <div class="modal-footer">
                                    <a href="?page=deleted&id=<?= $comment->id ?>" id="<?= $comment->id?>" class="modal-action modal-close waves-effect waves-red btn-flat delete_comment"><i class="material-icons">delete</i></a>
