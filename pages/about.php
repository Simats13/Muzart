...
<div class="preloader">
 ...
 <section class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="assets/img/photo/DSC_9732.jpg" data-speed="0.7">
            ...
            <div class="section-inner nopaddingbottom">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="mt30"><a href="?page=contact" class="btn btn-primary btn-theme page-scroll"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Contactez-moi","Contact me");
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 match-height">
                            <div class="vertical-center">
                                <h2 class="section-heading"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Oeuvres","Most popular");
                            echo $description[$langue]; ?> </h2>
                                <h3 class="section-subheading secondary-font"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Les plus populaires","Works");
                            echo $description[$langue]; ?> </h3>
                            </div>
                        </div>
                    </div>
                </div>
