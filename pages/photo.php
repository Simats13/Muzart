...
<div class="preloader">
        ...
        <section class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="assets/img/photo/IMG_3307.jpg" data-speed="0.7">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center mb50">
                            ...
                            echo $description[$langue]; ?></a></li>
                                <li><a class="btn btn-primary" href="#" data-filter=".photographie"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Photo","Photo");
                            echo $description[$langue]; ?></a></li>
                            ...
                            echo $description[$langue]; ?></a></li>
                                <li><a class="btn btn-primary" href="#" data-filter=".exposition"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Expositions","Expositions");
                            echo $description[$langue]; ?></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div>
                        <ul class="portfolio-items nopadding-lr isotope list-unstyled">
                            ...
                            <li class="col-sm-6 col-xs-6 portfolio-item nopadding-lr <?= $image->category ?> isotope-item hover-item">
                                <img src="portfolio/img/posts/<?= $image->image?>" class="img-responsive smoothie" alt="" width="100px" height="100px">
                                <div class="overlay-item-caption smoothie"></div>
                                <div class="hover-item-caption smoothie">
                                    <div class="vertical-center smoothie">
                                        <h3 class="smoothie mb30"><a href="portfolio/?page=post_image&id=<?= $image->id ?>" title="view project">Photo</a></h3>
                                        <a href="portfolio/?page=post_image&id=<?= $image->id ?>" title="View Gallery" class="btn btn-primary lb-link smoothie">Zoom</a>
