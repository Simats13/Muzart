            ...
            if($page != 'login' && $page != 'new' && $page != 'password'){
                ?>
                    ...
                    <ul class="right hide-on-med-and-down">
                        <li class="<?php echo ($page=="principal")?"active" : ""; ?>"><a href="index_video.php?page=principal"><i class="material-icons">dashboard</i></a></li>
                    ...
                    <ul class="side-nav" id="mobile-menu">
                        <li class="<?php echo ($page=="principal")?"active" : ""; ?>"><a href="index_video.php?page=principal">Tableau de bord</a></li>
