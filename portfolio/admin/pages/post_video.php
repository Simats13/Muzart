...
if(isset($_GET['delete'])) {
    $req=$db->query('DELETE FROM video WHERE id= '.$_GET['delete']);
    header('Location:?page=list_video');
...
?>
    ...
    <div class="col s6">
        ...
        <a href="?page=post_video&id=<?= $post->id ?>&delete=<?=$post->id?>" class="btn btn-danger" id="delete" name="delete" onclick="return confirm('Voulez-vous supprimer l\'article ?')"  onclick="document.location.href= '?' ">Supprimer</a> 
