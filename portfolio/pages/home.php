...
<div class="preloader">
        ...
        <section class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="../assets/img/photo/DSC00386-1.jpg" data-speed="0.7">
        ...
        <div style="float:right;">
					<a href="?" target="_self"><img src="../assets/flags/fr.jpeg" width="40px"  class="drapeau" /></a>
					<a href="?&lang=en" target="_self"><img src="../assets/flags/en.png" width="40px"  class="drapeau" /></a>
				</div>
                                ...
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            ...
                                            <a href="img/posts/<?= $image->image ?>" title="Zoomer" class="btn btn-primary lb-link smoothie"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Visionner la photo","See the photo");
                            echo $description[$langue]; ?></a>
                                            <a href="?page=post_image&id=<?= $image->id ?>" class="smoothie btn btn-primary"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("En savoir plus","See more ");
                            echo $description[$langue]; ?></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <figure class="media"><oembed url="<?= $video->image?>"></oembed></figure>
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            ...
                                            <a href="<?= $video->image?>" class="smoothie btn btn-primary"><?php $langue=0;
                                if(isset($_GET["lang"]))
                                $langue=1;
                                $description = array("Visionner la vidéo","Watch the vidéo");
                            echo $description[$langue]; ?></a>
